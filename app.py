...
def place_order():
    ...
    try:
        ...
        # Insert order items + update stock + inventory log
        for item in order_items:
            ...
            prev_stock = cursor.fetchone()['stock']
            ...
            cursor.execute(
                "UPDATE products SET purchases = purchases + %s WHERE id = %s",
                (item['quantity'], item['product_id'])
            )
